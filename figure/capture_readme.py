...
FIGURE = ROOT / "figure"
SAMPLE = ROOT / "samples" / "python_basic"
PRACTICE = ROOT / "figure" / "_practice_tmp"
...
def capture() -> None:
    ...
    try:
        with sync_playwright() as p:
            ...
            sample_code = (SAMPLE / "src" / "math_utils.py").read_text(encoding="utf-8")
            string_code = (SAMPLE / "src" / "string_utils.py").read_text(encoding="utf-8")
